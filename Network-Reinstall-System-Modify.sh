...
if [ $CXTisCN != "Yes" ];then
    ...
    #wget -O
    wget --no-check-certificate -qO ~/Core_Install.sh 'https://github.com/o-liverkk/Network-Reinstall-System-Modify/raw/master/CoreShell/Core_Install_v5.3.sh' && chmod a+x ~/Core_Install.sh
    CentOSMirrors=""
    CentOSVaultMirrors=""
    DebianMirrors=""
    UbuntuMirrors=""
    ...
    #wget -O
    wget --no-check-certificate -qO ~/Core_Install.sh 'https://ghproxy.com/https://github.com/o-liverkk/Network-Reinstall-System-Modify/raw/master/CoreShell/Core_Install_v5.3.sh' && chmod a+x ~/Core_Install.sh
    CXTrandom=$RANDOM
